...
toGregorian :: Day -> (Int32,Int32,Int32)
...
fromGregorian :: Int32 -> Int32 -> Int32 -> Day
...
fromGregorianValid :: Int32 -> Int32 -> Int32 -> Maybe Day
...
gregorianMonthLength :: Int32 -> Int32 -> Int32
gregorianMonthLength year = monthLength (isLeapYear year)

rolloverMonths :: (Int32,Int32) -> (Int32,Int32)
rolloverMonths (y,m) = (y + (div (m - 1) 12),fromIntegral (mod (m - 1) 12) + 1)

addGregorianMonths :: Int32 -> Day -> (Int32,Int32,Int32)
...
addGregorianMonthsClip :: Int32 -> Day -> Day
...
addGregorianMonthsRollOver :: Int32 -> Day -> Day
...
addGregorianYearsClip :: Int32 -> Day -> Day
...
addGregorianYearsRollOver :: Int32 -> Day -> Day
